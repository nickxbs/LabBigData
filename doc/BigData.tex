...
Definita una relazione $\prec$ di ordinamento dei nodi in base al grado, si può assumere che ogni trinagolo sia formato da 3 nodi (x,y,z) i quali sono legati dalle 3 relazioni \textit{tipo A} (x,y) con x$\prec$y, \textit{tipo B} (x,z) con x$\prec$z e \textit{tipo C} (y,z) con y$\prec$z.\\
