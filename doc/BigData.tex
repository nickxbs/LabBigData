...
%%% Preamble
\documentclass[paper=a4, fontsize=11pt]	% Article class of KOMA-script with 11pt font and a4 format
...
contenuti in sesso. 
Il numero di questi triangoli rapportato al numero totale di triangoli che esisterebbero con una distribuzione casuale delle relazioni può essere un indice di quanto sia social il grafo analizzato.\\
...
Per progettare, implementare e testare il programma per il conteggio dei triangoli presenti in un grafo ho utilizzeto:
\paragraph{Infrastruttura}
Per semplicità e rapidita di configurazione o deciso di utilizzare Claudera, un distribuzione preconfigurata di Hadoop utlilizzando la versione Docker
...
\paragraph{Fase 1}
Il primo Job si occupa semplicemente di contare il numero degli archi presente nel grafo.
Il secondo Job analizza ogni node e ne calcola il grado
\paragraph{Fase 2}
