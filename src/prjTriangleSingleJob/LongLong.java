...
public class LongLong implements WritableComparable<LongLong> {
...
public LongLong(Long first, Long second) {
	  this.set(new LongWritable(first), new LongWritable(second));
	}
public LongLong(int first, int second) {
	  this.set(new LongWritable(first), new LongWritable(second));
	}

public LongLong(LongWritable first, LongWritable second) {
...
@Override
public int compareTo(LongLong tp) {
...
static {
 WritableComparator.define(LongLong.class, new Comparator());
}
...
@Override
 public int compare(WritableComparable a, WritableComparable b) {
   if (a instanceof LongLong && b instanceof LongLong) {
     return ((LongLong) a).getFirst().compareTo(((LongLong) b).getFirst());
   }
